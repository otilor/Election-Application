...
<section class="random-div bg-not-too-white text-mpgray">
	...
	<div>
		<h3 class="text-23px pt-5 pb-1 text-mpgray mx-auto random-div-title-description text-center">{{ $user->name }}</h3>

	<h4 class = "text-center">Your email address:  {{ $user->email }} </h4>		
	</div>
