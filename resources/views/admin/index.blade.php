...
<div class="container">
        ...
        <div class="flex-grow story-ended p-5 br-20px m-1 col-md-12 bg-mpblue">
          ...
          <div class="end-of-story-button mt-20px">
            <a href = "polls/3 " class="py-3 br-10px px-4 bg-msblue-600  text-caps">Check out!</a>
          </div>
        </div>
      </div>
        </div>
...
<div class="container">
        ...
        <div class="flex-grow story-ended p-5 br-20px m-1 col-md-12 bg-success">
          <h2 class="text-headline text-white">Admin dashboard</h2>
          <div class="end-of-story-button mt-20px">
            <a href = "polls/3 " class="py-3 br-10px px-4 bg-light text-dark text-caps">Check out!</a>
          </div>
        </div>
      </div>
        </div>
